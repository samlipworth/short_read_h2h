...
I have then assembled using Shovill (Spades) and Skesa performing two independent assemblies with each assembler. There are therefore 10x2x3x2 = 120 assenblies in total.
...
2. Assembly metrics
3. Assembly comparison between providers
4. Assembly comparison between assembly methods
...
I think the conclusion is that Novogene data seems to be the highest quality but this is very marginal and all providers produce high quality and comparable data.
